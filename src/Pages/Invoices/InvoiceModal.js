...
const InvoiceModal =(props)=> {
    ...
    const submit =(e) =>{
        ...
        axios.post('http://127.0.0.1:8000/api/invoice/register/',{
            dateCreated : props.dateOfIssue,
            customer : props.billTo,
            totalPrice : props.total,
            discount : props.discountAmmount,
            paid : props.total,
            userName : props.billFrom,
            userAddres : props.billFromAddress,
            userMobile : props.billFromEmail,
            tax : props.taxAmmount,
            items : [
                {
                    product: 1,
                    quantity: 5
